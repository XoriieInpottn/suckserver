...
public class SuckServiceImpl extends UnicastRemoteObject implements SuckService {
	...
	@Override
	public long createTask(String template, boolean isTest)
	...
	@Override
	public long createTaskFromFile(String path, boolean isTest)
			throws RemoteException {
		String template;
		try {
	...
	@Override
	public List<Log> getLogs(long tid, Date after, int maxCount)
			throws RemoteException {
