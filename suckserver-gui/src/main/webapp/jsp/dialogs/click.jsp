...
<div id="dialog-click" title="Set click">
	<fieldset>
		<label style="display:block;margin-bottom:5px">path</label>
		<input type="text" id="click-path" name="path" style="display:block;width:100%" /> 
	</fieldset>
	<fieldset>
		<label  style="display:block;margin-bottom:5px">count</label>
